      ...
      <div className="w-4/5 md:flex flex-row">
        <div className="bg-white p-3 mt-3 rounded-lg mr-1 w-full md:w-2/6">
          <h3 className="px-3 text-gray-600 font-bold p-1">
            Today{" "}
            <span className="font-normal text-gray-400 text-xs">({date})</span>
          </h3>
          <div className="w-full p-3 flex items-center">
            <div className="flex-1">
              ...
              <h3 className="p-1 text-gray-600">{w.current.condition.text}</h3>
            </div>
            <div className="w-24">
              <Image
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <div className="mx-3">
              ...
              <h3 className="font-bold text-gray-600">{w.current.humidity}%</h3>
            </div>
            <div className="mx-3">
